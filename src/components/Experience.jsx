...
const Experience = () => {
  ...
  return (
    ...
    >
        <div className="max-w-screen-lg mx-auto p-4 pt-80 flex flex-col justify-center w-full h-full text-white">
           
            <div> 
                <p className="text-4xl font-bold border-b-4 border-gray-500 p-2 pt-16 inline">Experience</p>
                <p className="py-6">These are the technologies I've worked with</p>
               
            </div>
            {/* mobile devices will have grid of 2 columns, desktop will have grid of 3 columns */}
